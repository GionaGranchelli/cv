...
\quote{Hands-on JVM engineer with 10+ years of experience designing, building, and operating distributed systems in banking, fintech, and cloud-native environments. Deep Java/Kotlin engineering across Spring Boot, Kafka, CQRS, and Kubernetes-based platforms, paired with developer tooling and governed AI-assisted engineering workflows. Currently Chapter Lead Java \& VueJS at ABN AMRO: technically hands-on while leading approximately 45 engineers across 5 teams in a regulated banking environment.}
%----------------------------------------------------------------------------------
% content
%----------------------------------------------------------------------------------
\begin{document}
...
Java, Kotlin, JVM, Spring Boot, REST APIs, microservices, gRPC, enterprise backend systems
}
\cvitem{Developer Tooling}{
IntelliJ Platform plugins, agentic coding workflows, CI/CD, paved-road tooling, developer productivity
}
\cvitem{Distributed Systems}{
Kafka, CQRS, event-driven architecture, Axon Framework, data pipelines, asynchronous messaging
}
\cvitem{Cloud \& Platform}{
Kubernetes, Docker, Azure AKS, AWS, cloud-native migration, deployment patterns, platform engineering
}
\cvitem{Reliability \& Production}{
Observability, incident investigation, root-cause analysis, reliability engineering, production validation
}
\cvitem{AI \& Agentic Systems}{
Governed agentic workflows, approval controls, auditable execution, portable model providers, multi-agent orchestration
}
...
{}{\textbf{Copilot Champion \& AI Adoption Lead.} Technically hands-on JVM engineer who also operates at significant organizational scope: Chapter Lead for approximately 45 engineers across 5 teams, accountable for engineering capability, technical standards, and cross-team delivery in a regulated banking environment.
\begin{itemize}
 ...
 \item Chapter leadership: coach and develop engineers, contribute to performance management and hiring processes, run architecture reviews, and translate priorities into executable delivery plans in partnership with Product, Architecture, Security, and Risk.
